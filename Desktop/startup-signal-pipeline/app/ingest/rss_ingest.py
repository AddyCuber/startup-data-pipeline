...
STRONG_KEYWORDS = {
    "raises", "secures", "bags", "closes round", "lands", "nabs", "funding", "invests"
}

CONTEXT_KEYWORDS = {
    "series a", "series b", "series c", "series d", "series e",
    "seed", "pre-seed", "angel", "valuation", "venture capital", "equity"
}
...
def fetch_recent_articles(days_back: int = 3):
    ...
    for feed_url in FEEDS:
        ...
        for entry in parsed.entries:
            ...
            title_lower = title.lower().replace("-", " ")  # normalization step
